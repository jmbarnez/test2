...
return {
    ...
    components = {
            ...
            parts = {
                {
                    ...
                    type = "polygon",
                    points = hull_points,
                    fill = { 0.52, 0.08, 0.1, 1 },
                    stroke = { 0.85, 0.18, 0.22, 1 },
                    strokeWidth = 2,
                },
                {
                    name = "core",
                    type = "polygon",
                    points = core_points,
                    fill = { 0.3, 0.06, 0.08, 1 },
                    stroke = { 0.65, 0.14, 0.18, 1 },
                    strokeWidth = 1,
                },
                {
                    name = "engine",
                    ...
                    fill = { 0.95, 0.32, 0.18, 0.9 },
                    stroke = { 1.0, 0.46, 0.24, 0.95 },
                    strokeWidth = 1,
                },
            },
        },
        ...
        loot = {
            entries = {
                {
                    credit_reward = constants.enemies.credit_rewards.enemy_scout,
                    xp_reward = constants.enemies.xp_rewards.enemy_scout,
                },
            },
        },
    },
