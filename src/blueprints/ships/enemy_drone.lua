            ...
            parts = {
                {
                    ...
                    type = "polygon",
                    points = hull_points,
                    fill = { 0.15, 0.7, 0.85, 1 },
                    stroke = { 0.35, 0.9, 1.0, 1 },
                    strokeWidth = 2,
                },
                {
                    name = "core",
                    type = "polygon",
                    points = core_points,
                    fill = { 0.1, 0.25, 0.38, 1 },
                    stroke = { 0.2, 0.5, 0.75, 1 },
                    strokeWidth = 1,
                },
                {
                    name = "wing_left",
                    ...
                    fill = { 0.12, 0.55, 0.7, 0.95 },
                    stroke = { 0.25, 0.75, 0.9, 1 },
                    strokeWidth = 1,
                },
                {
                    name = "wing_right",
                ...
                },
                {
                    ...
                    fill = { 0.9, 0.7, 0.2, 0.85 },
                    stroke = { 1, 0.85, 0.4, 0.9 },
                    strokeWidth = 1,
                },
            },
        },
