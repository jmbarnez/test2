...
local palette = {
    ...
    accent_player = { 0.3, 0.78, 0.46, 1 },
    accent_station = { 0.32, 0.52, 0.92, 1 },
...
components.hud = {
    colors = {
        ...
        status_bar_scale = { palette.border[1], palette.border[2], palette.border[3], 0.45 },
        ...
        energy_fill = { 0.98, 0.82, 0.18, 1.0 },
    },
}
