...
local BINDING_ACTIONS = {
    ...
    { id = "hotbarSlot1", label = "Select Hotbar Slot 1" },
    { id = "hotbarSlot2", label = "Select Hotbar Slot 2" },
    { id = "hotbarSlot3", label = "Select Hotbar Slot 3" },
    { id = "hotbarSlot4", label = "Select Hotbar Slot 4" },
    { id = "hotbarSlot5", label = "Select Hotbar Slot 5" },
    { id = "hotbarSlot6", label = "Select Hotbar Slot 6" },
    { id = "hotbarSlot7", label = "Select Hotbar Slot 7" },
    { id = "hotbarSlot8", label = "Select Hotbar Slot 8" },
    { id = "hotbarSlot9", label = "Select Hotbar Slot 9" },
    { id = "hotbarSlot10", label = "Select Hotbar Slot 10" },
